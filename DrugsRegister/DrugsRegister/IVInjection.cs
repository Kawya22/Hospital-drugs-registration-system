...
{
    public partial class IVInjection : UserControl
    {
        ...
        private void IVInjection_Load(object sender, EventArgs e)
        {
            FillCombobox();
            LoadData();
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (rdsIssues.Checked == true)
            {
                ...
                rdp = 0;
                SqlCommand cmd1 = new SqlCommand("select currentbalance from IVInjectionItems where itemname='" + cmbItemName.Text + "'", con);
                ...
                //update query
                SqlCommand cmd = new SqlCommand("insert into IVInjection (itemno,itemname,date,bht,issue,currentbalance) values('" + txtItemNo.Text + "','" + cmbItemName.Text + "','" + txtDate.Text + "','" + txtBht.Text + "','" + txtAmount.Text + "','" + Convert.ToString(curbal) + "')", con);
                ...
                SqlCommand cmd2 = new SqlCommand("update IVInjectionItems SET currentbalance='" + curbal + "'  WHERE itemname='" + cmbItemName.Text + "'", con);
            ...
            else if (rdsRdp.Checked == true)
            {
                ...
                SqlCommand cmd = new SqlCommand("insert into IVInjection (itemno,itemname,date,bht,rdp,currentbalance) values('" + txtItemNo.Text + "','" + cmbItemName.Text + "','" + txtDate.Text + "','" + txtBht.Text + "','" + txtAmount.Text + "','" + Convert.ToString(curbal) + "')", con);
                SqlCommand cmd2 = new SqlCommand("update IVInjectionItems SET currentbalance='" + curbal + "'  WHERE itemname='" + cmbItemName.Text + "'", con);
                cmd.Parameters.AddWithValue("@itemname", cmbItemName.Text);
                cmd.Parameters.AddWithValue("@itemno", txtItemNo.Text);
                cmd.Parameters.AddWithValue("@date", txtDate.Text);
        ...
        private void cmbItemName_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            SqlCommand sc = new SqlCommand("select * from IVInjectionItems where itemname='" + cmbItemName.Text + "'", con);
        ...
        void FillCombobox()
        {
            if (con.State == ConnectionState.Open)
                con.Close();
            con.Open();
            SqlCommand sc = new SqlCommand("select itemname from IVInjectionItems", con);
        ...
        public void LoadData()
        {
            ...
            con.Open();
            dt = new DataTable();
            adpt = new SqlDataAdapter("Select * from IVInjection", con);
            adpt.Fill(dt);
        ...
        void delete()
        {
            ...
            if (con.State == ConnectionState.Open)
                con.Close();
            con.Open();
            SqlCommand cmd3 = new SqlCommand("select * from IVInjection where no='" + lblNo.Text + "'", con);//items walin select kala
            ...
            if (bhtt == 0)
            {
                ...
                //update query
                SqlCommand cmd = new SqlCommand("Delete * from IVInjection where no='" + lblNo.Text + "'", con);
