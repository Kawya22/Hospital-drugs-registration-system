...
{
    public partial class SpecialIssues : UserControl
    {
        ...
        private void SpecialIssues_Load(object sender, EventArgs e)
        {
            FillCombobox();
            LoadData();
        }
        ...
        protected void FillCombobox()
        {
            if (con.State == ConnectionState.Open)
                con.Close();
            con.Open();
            SqlCommand sc = new SqlCommand("select itemname from SpecialIssueItems", con);
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (rdsIssues.Checked == true)
            {
                ...
                rdp = 0;
                SqlCommand cmd1 = new SqlCommand("select currentbalance from SpecialIssueItems where itemname='" + cmbItemName.Text + "'", con);
                ...
                //update query
                SqlCommand cmd = new SqlCommand("insert into SpecialIssues (itemno,itemname,date,bht,issue,currentbalance) values('" + txtItemNo.Text + "','" + cmbItemName.Text + "','" + txtDate.Text + "','" + txtBht.Text + "','" + txtAmount.Text + "','" + Convert.ToString(curbal) + "')", con);
                ...
                SqlCommand cmd2 = new SqlCommand("update SpecialIssueItems SET currentbalance='" + curbal + "'  WHERE itemname='" + cmbItemName.Text + "'", con);
            ...
            else if (rdsRdp.Checked == true)
            {
                ...
                SqlCommand cmd = new SqlCommand("insert into SpecialIssues (itemno,itemname,date,bht,rdp,currentbalance) values('" + txtItemNo.Text + "','" + cmbItemName.Text + "','" + txtDate.Text + "','" + txtBht.Text + "','" + txtAmount.Text + "','" + Convert.ToString(curbal) + "')", con);
                SqlCommand cmd2 = new SqlCommand("update SpecialIssueItems SET currentbalance='" + curbal + "'  WHERE itemname='" + cmbItemName.Text + "'", con);
                cmd.Parameters.AddWithValue("@itemname", cmbItemName.Text);
                cmd.Parameters.AddWithValue("@itemno", txtItemNo.Text);
                cmd.Parameters.AddWithValue("@date", txtDate.Text);
        ...
        void delete()
        {
            ...
            if (con.State == ConnectionState.Open)
                con.Close();
            con.Open();
            SqlCommand cmd3 = new SqlCommand("select * from SpecialIssues where no='" + lblNo.Text + "'", con);//items walin select kala
            ...
            if (bhtt == 0)
            {
                ...
                //update query
                SqlCommand cmd = new SqlCommand("Delete * from SpecialIssues where no='" + lblNo.Text + "'", con);
