...
{
    public partial class WeeklyIssues : UserControl
    {
        ...
        private void WeeklyIssues_Load(object sender, EventArgs e)
        {
            FillCombobox();
            LoadData();
        }
        ...
        private void cmbItemName_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            SqlCommand sc = new SqlCommand("select * from WeeklyIssueItems where itemname='" + cmbItemName.Text + "'", con);
        ...
        protected void FillCombobox()
        {
            ...
            SqlCommand sc = new SqlCommand("select itemname from WeeklyIssueItems", con);
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
           int issue, rdp;
            ...
            if (rdsIssues.Checked == true)
            {
                ...
                rdp = 0;
                SqlCommand cmd1 = new SqlCommand("select currentbalance from WeeklyIssueItems where itemname='" + cmbItemName.Text + "'", con);
                ...
                //update query
                SqlCommand cmd = new SqlCommand("insert into WeeklyIssues (itemno,itemname,date,bht,issue,currentbalance) values('" + txtItemNo.Text + "','" + cmbItemName.Text + "','" + txtDate.Text + "','" + txtBht.Text + "','" + txtAmount.Text + "','"+Convert.ToString(curbal)+"')", con);
                ...
                SqlCommand cmd2 = new SqlCommand("update WeeklyIssueItems SET currentbalance='" + curbal + "'  WHERE itemname='" + cmbItemName.Text + "'", con);
            ...
            else if (rdsRdp.Checked == true)
            {
                ...
                SqlCommand cmd = new SqlCommand("insert into WeeklyIssues (itemno,itemname,date,bht,rdp,currentbalance) values('" + txtItemNo.Text + "','" + cmbItemName.Text + "','" + txtDate.Text + "','" + txtBht.Text + "','" + txtAmount.Text + "','" + Convert.ToString(curbal) + "')", con);
                SqlCommand cmd2 = new SqlCommand("update WeeklyIssueItems SET currentbalance='" + curbal + "'  WHERE itemname='" + cmbItemName.Text + "'", con);
                cmd.Parameters.AddWithValue("@itemname", cmbItemName.Text);
                cmd.Parameters.AddWithValue("@itemno", txtItemNo.Text);
                cmd.Parameters.AddWithValue("@date", txtDate.Text);
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            void delete()
            {
                ...
                if (con.State == ConnectionState.Open)
                    con.Close();
                con.Open();
                SqlCommand cmd3 = new SqlCommand("select * from WeeklyIssues where no='" + lblNo.Text + "'", con);//items walin select kala
                ...
                if (bhtt == 0)
                {
                    ...
                    //update query
                    SqlCommand cmd = new SqlCommand("Delete * from WeeklyIssues where no='" + lblNo.Text + "'", con);
